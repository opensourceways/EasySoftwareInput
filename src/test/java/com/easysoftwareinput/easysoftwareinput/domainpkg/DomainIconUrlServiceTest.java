...
package com.easysoftwareinput.easysoftwareinput.domainpkg;
...
import com.easysoftwareinput.application.domainpackage.DomainIconUrlService;
...
@SpringBootTest
public class DomainIconUrlServiceTest {
    @Autowired
    private DomainIconUrlService service;
    ...
    public void validData() {
        ...
        List<DomainPkgDO> list = gateway.getBaseMapper().selectList(wrapper);
        for (DomainPkgDO pkg : list) {
    ...
    public void initDB() {
        ...
        for (int i = 0; i < names.size(); i++) {
            DomainPkgDO oepkg = new DomainPkgDO();
